...
public class StreamMethod2 {
    public static void main(String[] args) {
        ...
        System.out.println(list2.stream().filter(p->p%2==0).distinct().count());

        //filter examples with Strings
        ...
        .filter() only keeping all the even numbers in the stream
        .forEach() an action by on the lambda expression
        ...
        */
        ...
        System.out.println("more than 30 " + list4.stream().anyMatch(p->p>20));
