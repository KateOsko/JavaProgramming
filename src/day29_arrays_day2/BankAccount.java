...
public class BankAccount {
    public static void main(String[] args) {
        ...
        System.out.println("The Balance: " + bankAccountOne[3]);
        ...
        bankAccountTwo[2] = "12374523";
        bankAccountTwo[3]="12413r423r5";
        ...
        bankAccountThree[0] = firstName; // you can use a variable
        ...
        for (int i = 0; i<bankAccountFour.length; i++){
            ...
            bankAccountFour[i] = input.nextLine(); // stores value into the console
        }
