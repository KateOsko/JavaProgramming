...
public class ArrayIntro {
    public static void main(String[] args) {
        ...
        //approach 2 assigning the value right away
        ...
        System.out.println(cities); //this doesn't print the array the way we want
        ...
        System.out.println(Arrays.toString(cities)); // this method from Array class lets you print the Array fully
