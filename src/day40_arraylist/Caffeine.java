...
public class Caffeine {
    public static void main(String[] args) {
        ...
        ArrayList<String> drinks2 = new ArrayList<>(drinks); // accepting an ArrayList in the parameter
        System.out.println(drinks2);

        String [] allDrinks = {"coffee", "tea", " energy drink", " soda"};
        //ArrayList <String> drinks3 = new ArrayList <> (allDrinks); not valid because the array is not a valid argument. here is an ARRAY, NOT an ARRAYLIST
