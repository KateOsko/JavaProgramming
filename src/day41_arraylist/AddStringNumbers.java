...
public class AddStringNumbers {
    ...
    public static ArrayList<Integer> sumFromString(ArrayList<String> list) {
        ...
        for (String each : list) { // goes through every element of the ArrayList from params
            ...
            for (String eachDigit : each.split("")) { // converting the String each to an array by split with an empty space, it means the each String will be separated with each characters as separate String elemtnt
